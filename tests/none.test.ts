...
describe('Promises External API: Promise.none', () => {
    test('Resolve the main promise with the list of rejection reasons', async () => {
    ...
    test('Reject the main promise with the value of first fulfilled promise', async () => {
